      ...
      body: SafeArea(
        child:  Column(
          ...
          children: <Widget>[
            ...
            CustomText(text: "\MVR${widget.product.price }",size: 20,weight: FontWeight.w400),
            SizedBox(height: 10,),
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: ()async{
                   ...
                   bool value =  await authProvider.addToCart(product: widget.product, quantity: quantity);
                   if(value){
